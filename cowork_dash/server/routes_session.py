...
from cowork_dash.stream.sse_adapter import run_agent_stream
...
def create_session_router(
    ...
    async def inject_message(session_id: str, body: InjectRequest):
        ...
        processes it, streaming responses via the SSE connection.
        ...
        # Push synthetic user_message event so the browser shows a user bubble
